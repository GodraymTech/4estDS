...
class Tract(Base):
    ...
    town: Mapped[str | None] = mapped_column(String)
    ...
    effective_area_hm2: Mapped[float | None] = mapped_column(Float)
...
class Tiff(Base):
    ...
    tiff_type: Mapped[str] = mapped_column(String, default="invalid")
